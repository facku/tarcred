...
// Smooth scroll for the navigation menu and links with .scrollto classes
  $(document).on('click', '#navigation a, .mobile-nav a, .scrollto, .hero a', function(e) {
...
if( document.getElementById('range') ){
    const
            ...
            setValue = () => {
                if(isMobileDevice()){
                    const
                            newValue = (Number(((range.value - 0 - 1000) * 100) / (69000 - 0)) );
...
$(document).ready(function () {
    ...
    $("#send1").click(function(){
        ...
        if( $("#name").is(':valid') && $("#phone").is(':valid') && $("#email").is(':valid')){
                    ...
                    $("#errorEmail").hide("slow");
                     ...
                     $("#loan").validate({
                        rules:{
                            ...
                            dni1:{filesize:"Tama\u00F1o m\u00E1ximo de la imagen son 10 MB"},
                            dni2:{filesize:"Tama\u00F1o m\u00E1ximo de la imagen son 10 MB"}
                        }
                    });
                }else{
